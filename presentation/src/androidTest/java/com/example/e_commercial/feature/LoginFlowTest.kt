package com.example.e_commercial.feature
...
import com.example.e_commercial.MainActivity
...
class LoginFlowTest : KoinTest {
    ...
    fun loginWithCorrectCredentials() {
        waitForLoginScreen()
        composeTestRule.onNodeWithTag("emailField").performTextInput("uwe1@gmail.com")
        composeTestRule.onNodeWithTag("passwordField").performTextInput("uwe1123456")
    ...
    fun loginWithWrongCredentials() {
        waitForLoginScreen()
        composeTestRule.onNodeWithTag("emailField").performTextInput("uwe2@gmail.com")
